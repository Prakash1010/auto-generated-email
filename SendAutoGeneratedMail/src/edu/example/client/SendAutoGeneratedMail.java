 ...
 */
public class SendAutoGeneratedMail implements EntryPoint {
	...
	private void loadContent() {
		...
		dialogBox.setText("Email information");
		...
		dialogVPanel.add(new HTML("<b>Sending e-mail id to the server:</b>"));
		...
		class MyHandler implements ClickHandler, KeyUpHandler {
			...
			private void sendNameToServer() {
				...
				if (!FieldVerifier.isValidEmail(textToServer)) {
